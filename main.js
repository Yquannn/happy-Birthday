...
function checking(){
  if(score.losses === 10  ){
    alert('HAHAHA ulit naka 10 ka nang losses')
    reset()
  }else if(score.ties === 10){
    alert('HAHAHA ulit naka 10 ka nang tie')
    reset()
  }
}
...
function navigateToPage() {
  if(score.wins >= 10){
  window.location.href = "greet/index.html";

  }else{
    alert('kelangan mo maka 10 wins bago pindutin yan hahaha')  
  }
}
